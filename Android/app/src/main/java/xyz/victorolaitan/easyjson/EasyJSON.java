...
public class EasyJSON {
    ...
    private EasyJSON() {
        rootNode = new JSONElement<Void>(null, JSONElementType.ROOT, null, null);
    }
        ...
        try {
            if (!filePath.equals("")) {
                ...
                for (Object key : obj.keySet()) {
                    ...
                    JSONElement parentElement = new JSONElement<>(null, type, key.toString(), value);
            ...
            throw new UnexpectedTokenException("The file specified is not properly defined.");
        } catch (IOException e) {
